...
import { Group, Header, CellButton, Caption, Div, List, Cell, Input } from '../../../web_modules/@vkontakte/vkui.js';
...
export class TimeCodeEditor extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Group, {
      ...
      onBlur: () => {
        this.sortPodcast(); // this.setPodcastTimeCodeTime(
        //   index,
        //   timeFormat(timeCode.time),
        // );
      }
    }))))), /*#__PURE__*/React.createElement(CellButton, {
      before: /*#__PURE__*/React.createElement(Icon24Add, null),
